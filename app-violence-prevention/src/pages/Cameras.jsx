                                    ...
                                    <div key={camera.id} className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 group">
                                        ...
                                        <div className="p-6">
                                            ...
                                            <button
                                                ...
                                                className={`mt-6 w-full py-3 px-4 rounded-xl font-bold text-white transition-all duration-300 transform hover:scale-[1.02] shadow-lg hover:shadow-xl ${camera.estado === 'activa'
